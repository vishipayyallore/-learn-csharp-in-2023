...
string key = _configuration["CompletionConfiguration:OPEN_API_Key"]!;
var openAiEndPoint = new Uri(_configuration["CompletionConfiguration:OPEN_API_EndPoint"]!);
var azureKeyCredential = new AzureKeyCredential(key);
var modelDeploymentName = _configuration["CompletionConfiguration:ModelDeploymentName"]!;
